...
<!-- Mirrored from demo.dashboardpack.com/directory-html/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 30 Sep 2023 01:13:43 GMT -->
<head>

<meta charset="utf-8" />
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
<title>Anisette Pure Living</title>
<link rel="icon" href=" <?=base_url() ?>admin/img/logo.png" type="image/png">
...
<link rel="stylesheet" href=" <?=base_url() ?>admin/vendors/swiper_slider/css/swiper.min.css" />

<link rel="stylesheet" href=" <?=base_url() ?>admin/vendors/select2/css/select2.min.css" />
...
<script src="<?=base_url() ?> admin/vendors/swiper_slider/js/swiper.min.js"></script>
...
<script src="<?=base_url() ?> admin/vendors/gijgo/gijgo.min.js"></script>
...
<script src="<?=base_url() ?> admin/vendors/apex_chart/apexcharts.js"></script>
<script src="<?=base_url() ?> admin/vendors/apex_chart/apex_realestate.js"></script>
...
<script src="<?=base_url() ?> admin/vendors/apex_chart/bar_active_1.js"></script>
<script src="<?=base_url() ?> admin/vendors/apex_chart/apex_chart_list.js"></script>