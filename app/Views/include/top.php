...
<!-- Mirrored from spacingtech.com/html/vegist-final/vegist/index1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Sep 2023 12:03:29 GMT -->
...
<head>
        ...
        <!-- favicon -->
        <link rel="shortcut icon" type="image/favicon" href="<?= base_url() ?>image/fevicon.png">
        <!-- bootstrap -->
        <link rel="stylesheet" type="text/css" href="<?= base_url() ?>css/bootstrap.min.css">
        <!-- simple-line icon -->
        <link rel="stylesheet" type="text/css" href="<?= base_url() ?>css/simple-line-icons.css">
        <!-- font-awesome icon -->
        <link rel="stylesheet" type="text/css" href="<?= base_url() ?>css/font-awesome.min.css">
        <!-- themify icon -->
        <link rel="stylesheet" type="text/css" href="<?= base_url() ?>css/themify-icons.css">
        <!-- ion icon -->
